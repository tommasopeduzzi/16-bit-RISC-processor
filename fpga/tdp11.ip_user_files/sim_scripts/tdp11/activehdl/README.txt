...
#
# Generated by export_simulation on Wed Aug 24 15:15:49 CEST 2022
#
################################################################################
...
'-reset_run' switch to the './tdp11.sh' script.
...
./tdp11.sh -noclean_files

For more information on the script, please type './tdp11.sh -help'.
