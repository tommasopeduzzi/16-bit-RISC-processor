...
architecture STRUCTURE of tdp11_control_0_0_control is
  ...
  signal pc_inc_i_8_n_0 : STD_LOGIC;
  signal pc_inc_i_9_n_0 : STD_LOGIC;
...
begin
\current_opcode_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      IS_C_INVERTED => '1'
    )
        port map (
...
\current_opcode_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      IS_C_INVERTED => '1'
    )
        port map (
...
\current_opcode_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      IS_C_INVERTED => '1'
    )
        port map (
...
\current_opcode_reg[3]\: unisim.vcomponents.FDRE
    generic map(
      IS_C_INVERTED => '1'
    )
        port map (
...
\current_opcode_reg[4]\: unisim.vcomponents.FDRE
    generic map(
      IS_C_INVERTED => '1'
    )
        port map (
...
\current_opcode_reg[5]\: unisim.vcomponents.FDRE
    generic map(
      IS_C_INVERTED => '1'
    )
        port map (
...
pc_inc_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
pc_inc_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
pc_inc_i_8: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
pc_inc_i_9: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
U0: entity work.tdp11_control_0_0_control
     port map (
      addr_pc_sel => \^addr_pc_sel\,
      clk => clk,
      current_opcode(5 downto 0) => current_opcode(5 downto 0),
      input(5 downto 0) => input(5 downto 0),
      rst => rst
    );
end STRUCTURE;
